...
لإضافة هذه القناة إلى قائمة القنوات المحمية:
1. تأكد من أنك مالك القناة
2. تأكد من منح البوت صلاحيات المشرف
3. اضغط على الزر أدناه لتأكيد الإضافة

⚠️ هام: البوت يحتاج صلاحيات "حظر الأعضاء" و "إدارة المشرفين"''',

                'add_admin_instructions': '''👤 إضافة مشرف للمراقبة

لإضافة مشرف للمراقبة، استخدم الأمر:
/add_admin [رقم_المشرف]

مثال:
/add_admin 123456789

📋 طريقة الحصول على رقم المشرف:
1. اطلب من المشرف إرسال /start للبوت
2. أو استخدم @userinfobot للحصول على الرقم
3. أو أرسل له رسالة واضغط على "إعادة التوجيه" لترى الرقم

⚠️ يجب أن يكون المشرف موجود فعلاً في القناة''',
